...
public class SecurityConfig {
        ...
        http
                ...
                .oauth2Login(oauth2Login -> oauth2Login
                        .authenticationSuccessHandler((webFilterExchange,
                                authentication) -> Mono.fromRunnable(() -> webFilterExchange.getExchange().getResponse()
                                        .getHeaders().setLocation(URI.create("/sinke-resources"))).then())
                        .authenticationFailureHandler((webFilterExchange, exception) -> Mono
                                .fromRunnable(() -> webFilterExchange.getExchange().getResponse()
    ...
    public ReactiveClientRegistrationRepository reactiveClientRegistrationRepository() {
        ...
        ClientRegistration registration = ClientRegistration.withRegistrationId("keycloak")
                ...
                .redirectUri("http://192.168.64.6:8081/realms/master/broker/oidc/endpoint")
                .authorizationUri("${KEYCLOAK_AUTH_SERVER_URL}")
